...
const ImageUpload = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // The id should be generated by the backend canister, so for a new image we should first maybe put a 0 that will be replaced by the backend canister
      const id = 0;
      ...
      const images = [
        {
          ...
          metadata: {
            ...
            file_size: BigInt(selectedImage.size),
            ...
            visibility: [],
            people: [],
            preview: [], // You might want to generate a compressed preview here
          },
        },
      ];

      console.log(JSON.stringify(images, null, 2)); // Log the data structure

      // Call the 'store_images' function on the backend canister
